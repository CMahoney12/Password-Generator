...
// need a confirm to ask the user if they want to use lowercase
...
// need a confirm to ask the user if they want to use uppercase
...
// need a confirm to ask the user if they want to use numeric
...
// need a confirm to ask the user if they want to use special characters    
